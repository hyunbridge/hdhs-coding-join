...
class HomePage extends React.Component<IHomePageProps, IHomePageState> {
  ...
  handleClick = async () => {
    const result: SweetAlertResult<any> = await SwalDefault.fire({
      html:
        '<h3><a href="https://www.notion.so/c23f95d4dc6b49b1a4e0e64a496a3e36" target="_blank">개인정보처리방침</a>에 동의하시나요?</h3>',
  ...
  render() {
    return (
      <div className="warp py-5 text-center">
        ...
        <h3>무엇을 하나요?</h3>
        <p>
          멘티-멘토 활동을 통해 Python의 기초를 배우고, 나아가 개인별 혹은
          팀별로 간단한 프로그램을 구상하고 작성해 보는 활동을 계획하고
          있습니다. 그러나, 코로나 19 혹은 학교의 사정 등으로 활동이 일부 변경
          혹은 삭제될 수 있음을 알아두시기 바랍니다.
        </p>
        <h3>누가 지원할 수 있나요?</h3>
        <p>
          실력에 관계 없이, 컴퓨터를 싫어하지만 않는 흥덕고등학교 학생이라면
          누구나 지원할 수 있습니다.
        </p>
        <h3>어떻게 지원할 수 있나요?</h3>
